<!--Action Button-->
@if( Active::checkUriPattern( 'admin/eventcategories' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.eventcategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.eventcategories.all' ) }}
            </a>
        </li>
        @permission( 'create-eventcategory' )
            <li>
                <a href="{{ route( 'admin.eventcategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.eventcategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
