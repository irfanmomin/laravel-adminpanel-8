...
return [
	...
	"eventcategories" => [
	"already_exists" => "That EventCategory already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this EventCategory. Please try again.",
	"delete_error" => "There was a problem deleting this EventCategory. Please try again.",
	"not_found" => "That EventCategory does not exist.",
	"update_error" => "There was a problem updating this EventCategory. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://7-laravel-adminpanel.test/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
